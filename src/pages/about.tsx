    ...
    return (
        <Box>
            <Box sx={{ display: 'flex', flexDirection: 'column', paddingTop: '7vh', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                ...
                <Typography sx={{ fontWeight: 'bold', fontsize: '30px', paddingTop: '3vh', paddingBottom: '3vh' }}>
                    ช่องทางการติดต่อ
                </Typography>
                <Box sx={{ background: 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)', width: 'auto', padding: '2vh ', borderRadius: '2vh', boxShadow: '0 3px 5px 2px rgba(255, 105, 135, .3)', }}>
                    <Typography sx={{ color: 'white'}}>
                        ...
                        087-2948188
                        <br />
                        Email: Nutcharee.Kongtyuang@gmail.com
                    </Typography>
                </Box>
                <Box sx={{ background: 'linear-gradient(45deg, #2196F3 30%, #21CBF3 90%)', width: '300px', padding: '2vh', marginTop: '1vh', borderRadius: '2vh', boxShadow: '0 3px 5px 2px rgba(255, 105, 135, .3)', }}>
                    <Typography sx={{ color: 'white'}}>
